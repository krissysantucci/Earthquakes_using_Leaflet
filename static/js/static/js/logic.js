...
console.log(myCircles)
  ...
  // Create our map, giving it the maps and earthquakes layers to display on load
  var myMap = L.map("map", {
      center: [
        37.09, -95.71
      ],
  ...
  info.onAdd = function() {
      ...
      var mags = ["0-1 Mag", "1-2 Mag", "2-3 Mag", "3-4 Mag", "4-5 Mag", "5+ Mag"];
...
// Create a layer control
  // Pass in our baseMaps and overlayMaps and legend(info)
